 ...
 * Matches in product name are weighted higher than matches in description
 */
...
/**
 * Fetch all products by category slug
...
/**
 * Fetch products by a list of product IDs
 * Used for cart, and checkout pages
 * Params: { ids: string[] }
 */
...
/**
 * AI-powered product search query
 */
